                            ...
                            >
                                ...
                                <Link to={`/project/${project.slug}`} className="block relative">
                                    ...
                                    >
                                        ...
                                        <div className={`absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center gap-4 transition-all duration-300 ${hoveredProject === index ? 'opacity-100' : 'opacity-0'
                                            }`}>
                                    ...
                                    <div className="absolute top-4 left-4 flex gap-2">
                                        <span className={`px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${project.category === 'orivon-venture' ? 'from-purple-600 to-purple-700' : 'from-blue-600 to-blue-700'
                                            } text-white`}>
                                ...
                                <div className="p-8">
                                    ...
                                    <Link
                                        ...
                                        className={`inline-flex items-center gap-2 text-sm font-semibold ${project.category === 'orivon-venture' ? 'text-purple-400 hover:text-purple-300' : 'text-blue-400 hover:text-blue-300'
                                            } transition-colors`}
                                    >
